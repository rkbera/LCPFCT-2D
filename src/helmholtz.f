...
C
  ...
  148 CONTINUE
      RETURN
      END
      SUBROUTINE MERGE1 (TCOS,I1,M1,I2,M2,I3)
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION       TCOS(1)
C
C
...
C
  ...
  133 CONTINUE
      ...
      CALL MERGE1 (TCOS,0,JST,JST,LR,KR)
  134 CONTINUE
...
C
  ...
  141 CONTINUE
      ...
      CALL MERGE1 (TCOS,0,I2R,I2R,LR,KR)
      GO TO 144
  142 DO 143 I=1,I2R
         II = KR+I
         TCOS(II) = TCOS(I)
...
C
  ...
  189 CONTINUE
      ...
      K4 = K1+KR+1
      CALL COSGEN (JR-1,1,0.0D0,1.0D0,TCOS(K4))
      CALL MERGE1 (TCOS,K1,KR,K1+KR,JR-1,0)
